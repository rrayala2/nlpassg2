...
class ReadPDFArgs(BaseModel):
    file_path: str = Field(..., description="/mnt/d/lancers/nlp hw 2/gentopia-mason/GentPool/gentpool/pool/NLP-Agent-2/4. DCGANs.pdf")
...
class ReadPDF(BaseTool):
    ...
    def _run(self, **kwargs) -> str:
        file_path = kwargs.get('file_path')  # Extract file_path from keyword arguments
        if not file_path:
